			...
			<div class="col12"><form action="pdf/" method="get" target="_blank">
				<p style="text-align:left;">
					...
					while($result = mysql_fetch_assoc($query)){
						//$ahtml .= '<a href="pdf/index.php?report=credit_monthly_report&date='.$result['date'].'" target="blank">Report of '.$result['date'].'</a><br>';
					...
					<input type="hidden" name="report" value="credit_monthly_report">

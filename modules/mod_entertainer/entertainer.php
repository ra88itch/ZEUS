...
<section id="sec-account">
	<div class="warp">
		<?php showNav('entertainer', $_GET['mod'], $_GET['page']);?>		
		<div class="onerow">
			<div class="result">
				<div class="col12">
					<p>
						<table>
							...
							$sql = "SELECT * FROM `entertainer` ORDER BY `id` ASC LIMIT ".$start_on.", 20";
							$query = mysql_query($sql);
							while($row = mysql_fetch_assoc($query)){
							?>
								<tr>
									<td></td>
									<td><?php echo $row['entertainer_name']; ?></td>
									<td></td>
									<td></td>
									<td></td>
				...
				<div id="add" class="add">ADD NEW ENTERTAINER</div>
			</div>
		</div>
	</div>
</section>
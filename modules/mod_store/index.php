...
function getAddForm(){
	...
	$html .= '<ul class="form">';
	$html .= '<li><span class="label">รหัส</span><input type="text" id="code" maxlength="20" value=""></li>';
...
function addNewStock($name, $unit, $new_unit, $minimum, $code) {
	...
	$sql	= "INSERT INTO `stock` (`name`, `amount`, `unit`, `store_stock`, `minimum`, `code`) VALUES ('$name', '0', '$unit', '0', '$minimum', '$code')";
	$query	= mysql_query($sql);
